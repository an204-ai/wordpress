	...
	<div class="es-footer-cta-cards" id="dat-lich">
		<div class="es-cta-card" style="background-image: url('<?php echo esc_url( $cta_bg_1 ); ?>');">
			<div class="es-cta-card-content">
				...
				<p style="color: #cccccc; font-size: 14px; max-width: 460px; margin-bottom: 24px; font-weight: 300;">
					Cùng đội ngũ kiến trúc sư trưởng và chuyên gia kết cấu của EuroStyle hiện thực hóa công trình biểu tượng của bạn.
				</p>
				<a href="tel:1800282806" class="btn-es-pill-solid">
					<span>Gọi 1800 28 28 06</span>
				</a>
			</div>
		</div>
		...
		<div class="es-cta-card" style="background-image: url('<?php echo esc_url( $cta_bg_2 ); ?>'); border-left: 1px solid rgba(255,255,255,0.08);">
			<div class="es-cta-card-content">
				...
				<h3 class="serif-title">TRỞ THÀNH ĐỐI TÁC EUROSTYLE</h3>
				<p style="color: #cccccc; font-size: 14px; max-width: 460px; margin-bottom: 24px; font-weight: 300;">
					Tải bộ Company Profile và Hồ sơ năng lực Design &amp; Build mới nhất dành cho Chủ đầu tư và Nhà thầu chính.
				</p>
				<a href="<?php echo esc_url( home_url( '/nang-luc-dich-vu/' ) ); ?>" class="btn-es-pill-outline">
			...
			<div class="es-footer-grid">
				...
				<div class="es-footer-col">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="es-logo-brand" style="margin-bottom: 20px;">
						<span class="es-logo-text" style="font-size: 22px;">EUROSTYLE</span>
					...
					<p style="color: var(--es-text-muted); font-size: 13px; line-height: 1.8; margin-bottom: 20px;">
						Công ty Cổ phần Phong cách Âu Châu – Tổng thầu Thiết kế &amp; Thi công hoàn thiện các đại công trình văn phòng hạng A, tổ hợp thương mại và khách sạn nghỉ dưỡng 5 sao quốc tế.
					</p>
					<div style="font-size: 13px; color: #aaaaaa; display: flex; flex-direction: column; gap: 8px;">
						<div><strong style="color: var(--es-gold); font-weight: 400;">Hotline:</strong> 1800 28 28 06</div>
						<div><strong style="color: var(--es-gold); font-weight: 400;">Email:</strong> info@eurostyle.com.vn</div>
					</div>
				</div>
				...
				<div class="es-footer-col">
					...
					<div style="font-size: 13px; color: var(--es-text-muted); line-height: 1.8;">
						<p style="margin-bottom: 12px;"><strong style="color: #ffffff; font-weight: 400;">Hà Nội:</strong><br>EuroStyle Complex, 77 Nguyễn Thái Học, Ba Đình, Hà Nội</p>
						<p style="margin-bottom: 0;"><strong style="color: #ffffff; font-weight: 400;">TP. Hồ Chí Minh:</strong><br>EuroStyle Saigon Center, 216 Lý Tự Trọng, Quận 1, TP.HCM</p>
					</div>
				</div>
				...
				<div class="es-footer-col">
					...
					<p style="font-size: 13px; color: var(--es-text-muted); line-height: 1.8; margin-bottom: 16px;">
						Áp dụng hệ thống quản lý chất lượng ISO 9001:2015 và hệ thống an toàn sức khỏe nghề nghiệp ISO 45001:2018.
					</p>
					<span style="display: inline-block; border: 1px solid var(--es-border-gold); color: var(--es-gold); padding: 8px 16px; font-size: 11px; letter-spacing: 1.5px;">CHỨNG CHỈ NĂNG LỰC HẠNG I</span>
				</div>
			</div>

			<div class="es-footer-bottom-bar">
				<div>
					&copy; <?php echo date( 'Y' ); ?> EUROSTYLE DESIGN &amp; BUILD. Bản quyền thuộc về EuroStyle.
				</div>
